        ...
        <React.Fragment>
             <animated.div style={style}>
                <div className={classes.root}>
                    ...
                    <svg width="1540" height="412" viewBox="0 0 1540 412" fill="none">
